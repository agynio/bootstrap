...
REQUIRED_APPS_JSON='["vault","registry-mirror","minio","platform-db","litellm-db","agent-state-db","litellm","agent-state","notifications","docker-runner","platform-server","platform-ui"]'
