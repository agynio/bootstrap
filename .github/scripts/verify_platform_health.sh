...
REQUIRED_APPS_JSON='["cert-manager","trust-manager","ziti-controller","vault","registry-mirror","minio","platform-db","litellm-db","agent-state-db","threads-db","litellm","agent-state","notifications-redis","notifications","threads","chat","k8s-runner","platform-server","platform-ui"]'
