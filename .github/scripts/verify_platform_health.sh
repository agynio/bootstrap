...
REQUIRED_APPS_JSON='["cert-manager","trust-manager","ziti-controller","ziti-management","vault","registry-mirror","minio","platform-db","threads-db","chat-db","identity-db","runners-db","identity","authorization","gateway","runners","notifications-redis","notifications","threads","chat","k8s-runner"]'
